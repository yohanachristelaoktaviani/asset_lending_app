...
ActiveRecord::Schema.define(version: 2023_06_12_102753) do
  ...
  create_table "asset_returns", force: :cascade do |t|
    ...
    t.index ["code"], name: "index_asset_returns_on_code", unique: true
  end
  ...
  add_foreign_key "asset_loan_items", "users", column: "admin_id"
  ...
  add_foreign_key "asset_return_items", "users", column: "admin_id"
