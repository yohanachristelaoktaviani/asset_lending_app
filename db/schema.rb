...
ActiveRecord::Schema.define(version: 2023_06_12_102753) do
  ...
  add_foreign_key "asset_loan_items", "users", column: "admin_id", name: "fk_rails_admin_loan"
  ...
  add_foreign_key "asset_return_items", "users", column: "admin_id", name: "fk_admin_id"
